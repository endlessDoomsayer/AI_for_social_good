...
def get_data():
    ...
    # 3. GENERATED DATA
    # Cost parameters
    # https://www.mosaikosrl.net/batterie-accumulo-fotovoltaico/    c_b = 6500  # Cost per battery
...
def get_data_house():
    ...
    # 3. GENERATED DATA
    # Cost parameters
    # https://www.mosaikosrl.net/pannelli-fotovoltaici-per-privati/
    B = 6000 # B: battery capacity
    c_b = 3500  # Cost per battery
    # https://www.mosaikosrl.net/pannelli-fotovoltaici-per-privati/
    c_p = 2.200 # Cost per unit of power [pannel of 6kWp]
    ...
    c_e = 0,16053/1000 # Cost of energy €/Wh
