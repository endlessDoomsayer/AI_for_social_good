...
print("Solar production in the day 2023-07-25:", p)
...
def get_job_duration_per_machine(machine_name, day):
    # Ottieni la durata del lavoro per una macchina in un dato giorno
...
print(f"Energy production (p): {p}")
print(f"Max energy av3923,ailable (mmm): {mmm}")
