...
MODEL_4_1_POLICIES = { '_4_1_scip': (0, 0), '_4_1_CSP_alternatives': (0, 0), '_4_1_adapt': (0, 0)}
...
# Run Model 1
model_1_M, model_1_N = float('inf'), float('inf')
...
model_3_cost, model_3_M, model_3_N = float('inf'), float('inf'), float('inf')
